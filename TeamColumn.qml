...
Column {
  ...
  Row {
    width: parent.width
    Text { width: parent.width-scoreText.width; text: (!root.plainScores && root.leading && root.colorMode !== "minimal" ? "▲ " : (!root.plainScores && root.trailing && root.colorMode !== "minimal" ? "▼ " : "")) + root.teamName; elide: Text.ElideRight; color: root.emphasis; font.family: root.bar.fontFamily; font.pixelSize: Style.font.title; font.bold: true }
