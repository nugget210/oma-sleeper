...
Item {
  ...
  readonly property bool evaluable: player.slot !== "BN" && (live || gameStatus.state === "post") && Number(player.expected_samples||0) >= 2 && Number(gameStatus.progress||0) >= .10
  ...
  Item { id: gameProgress; width: root.live ? Style.space(58) : 0; height: parent.height; anchors.right: pts.left; anchors.rightMargin: root.live ? Style.space(7) : 0
